...
export default function Footer() {
  return (
    <footer className="bg-lime-600 text-white pt-16 pb-24 md:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-lime-500 transition-colors">
                <Globe size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-lime-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-lime-100 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-4 text-lime-100 text-sm">
              <li className="flex gap-3">
                <Phone size={18} className="shrink-0 text-lime-500" />
                <div>
              ...
              <li className="flex gap-3">
                <Mail size={18} className="shrink-0 text-lime-500" />
                <div>
              ...
              <li className="flex gap-3">
                <MapPin size={18} className="shrink-0 text-lime-500" />
                <div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-lime-200">
